        ...
        <main>
            ...
            <div class="filter-container">
                <div class="filter-group">
                    ...
                    <input type="text" id="searchGuest" placeholder="Nome do hóspede...">
                </div>
                <div class="filter-group">
                    <label>Status</label>
                ...
                <table id="reservasTable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <button class="btn btn-cancel btn-small">
                        ...
                        <tr>
                            ...
                            <td>3</td>
                            <td>R$ 600,00</td>
                            <td><span class="status-badge status-checkout">Hospedado</span></td>
                            <td>
                                <div class="action-buttons">
                                    <button class="btn btn-checkout btn-small">
