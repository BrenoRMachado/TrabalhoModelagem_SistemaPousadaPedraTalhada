    ...
    <form action="/admin/reservas/atualizar" method="POST" class="modal-editar-reserva">
        ...
        <div class="editar-reserva-input-container">
            <div class="editar-reserva-input">
                ...
                <input type="date" name="dataEntradaPrevista" id="edit-dataEntrada">
            </div>
            <div class="editar-reserva-input">
                <label>Data de Saída</label>
                <input type="date" name="dataSaidaPrevista" id="edit-dataSaida">
            </div>
        </div>
        
        <div class="editar-reserva-input-quarto">
            <label>Quarto</label>
            <select name="idQuarto" id="edit-quarto-select">
